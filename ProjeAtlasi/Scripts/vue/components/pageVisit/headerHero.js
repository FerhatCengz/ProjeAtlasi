export const HeaderHero = {
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-4">
        <h2 data-aos="fade-up">PROJE ATLASINA HOŞ GELDİN</h2>
        ...
        <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
          ...
          <a href="https://www.youtube.com/watch?v=hk8V8PT1tjw"
            class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Biz
              Kimiz</span></a>
        </div>
      </div>
    </div>
